#include <assert.h>  // assert proporciona una macro llamada .
#include <ctype.h>   // toupper eclara varias funciones que son útiles para probar y asignar caracteres.
#include <stdio.h>   // printf, scanf
#include <stdlib.h>  // rand
#include <unistd.h>  // getpid define constantes y tipos simbólicos misceláneos
...
#define CANTIDAD_MINAS \
  5  
#define DEBUG 0  // Si lo colocamos en 1, se van a desocultar las minas
